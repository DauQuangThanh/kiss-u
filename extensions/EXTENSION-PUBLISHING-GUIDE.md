...
This guide explains how to publish your extension to the kiss extension catalog, making it discoverable by `kiss extension search`.
...
extension:
  ...
  repository: "https://github.com/your-org/kiss-your-extension"
  license: "MIT"
  homepage: "https://github.com/your-org/kiss-your-extension"

requires:
  kiss_version: ">=0.1.0"    # Required kiss version

provides:
  commands:                       # List all commands
    - name: "kiss.your-extension.command"
...
# Go to: https://github.com/your-org/kiss-your-extension/releases/new
# - Tag: v1.0.0
...
```text
https://github.com/your-org/kiss-your-extension/archive/refs/tags/v1.0.0.zip
```
...
kiss extension add --dev /path/to/your-extension

# Test from GitHub archive
kiss extension add <extension-name> --from https://github.com/your-org/kiss-your-extension/archive/refs/tags/v1.0.0.zip
```
...
kiss uses a dual-catalog system. For details about how catalogs work, see the main [Extensions README](README.md#extension-catalogs).
...
### 1. Fork the kiss Repository

```bash
# Fork on GitHub
# https://github.com/DauQuangThanh/kiss-u/fork
...
```json
{
  ...
  "catalog_url": "https://raw.githubusercontent.com/DauQuangThanh/kiss-u/main/extensions/catalog.community.json",
  "extensions": {
    "your-extension": {
      ...
      "author": "Your Name",
      "version": "1.0.0",
      "download_url": "https://github.com/your-org/kiss-your-extension/archive/refs/tags/v1.0.0.zip",
      "repository": "https://github.com/your-org/kiss-your-extension",
      "homepage": "https://github.com/your-org/kiss-your-extension",
      "documentation": "https://github.com/your-org/kiss-your-extension/blob/main/docs/",
      "changelog": "https://github.com/your-org/kiss-your-extension/blob/main/CHANGELOG.md",
      "license": "MIT",
      "requires": {
        "kiss_version": ">=0.1.0",
        "tools": [
...
```markdown
| Your Extension Name | Brief description of what it does | `<category>` | <effect> | [repo-name](https://github.com/your-org/kiss-your-extension) |
```
...
# https://github.com/DauQuangThanh/kiss-u/compare
```
...
3. **Verification**:
   ...
   - Extension appears in `kiss extension search --verified`
...
4. **Update catalog**:
   ...
   ```bash
   # Fork kiss repo (or update existing fork)
   cd kiss
   ...
   jq '.extensions["your-extension"].download_url = "https://github.com/your-org/kiss-your-extension/archive/refs/tags/v1.1.0.zip"' extensions/catalog.json > tmp.json && mv tmp.json extensions/catalog.json
...
- Users add your catalog: `kiss extension add-catalog https://your-domain.com/catalog.json`
...
- **Catalog Issues**: <https://github.com/statsperform/kiss/issues>
- **Extension Template**: <https://github.com/statsperform/kiss-extension-template> (coming soon)
...
```json
{
  ...
  "requires": {
    "kiss_version": "string (required, version specifier)",
    "tools": [
      {
        "name": "string (required)",
