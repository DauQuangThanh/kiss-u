...
1. Read `.kiss/feature.json` to get the feature directory path.

2. **Load context**: `.kiss/memory/standardize.md` and `<feature_directory>/spec.md` and `<feature_directory>/plan.md` and `<feature_directory>/tasks.md`.
