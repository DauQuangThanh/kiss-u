...
This guide explains how to publish your preset to the kiss preset catalog, making it discoverable by `kiss preset search`.
...
6. **Testing**: Preset tested on real projects with `kiss preset add --dev`
...
preset:
  ...
  repository: "https://github.com/your-org/kiss-preset-your-preset"
  license: "MIT"
...
- ✅ Command names use dot notation (e.g. `kiss.specify`)
...
kiss preset add --dev /path/to/your-preset

# Verify templates resolve from your preset
kiss preset resolve spec-template

# Verify preset info
kiss preset info your-preset

# List installed presets
kiss preset list

# Remove when done testing
kiss preset remove your-preset
```
...
ls .claude/commands/kiss.*.md

# Check Copilot commands (if using Copilot)
ls .github/agents/kiss.*.agent.md

# Check Gemini commands (if using Gemini)
ls .gemini/commands/kiss.*.toml
```
...
```text
https://github.com/your-org/kiss-preset-your-preset/archive/refs/tags/v1.0.0.zip
```

### 5. Test Installation from Archive

```bash
kiss preset add --from https://github.com/your-org/kiss-preset-your-preset/archive/refs/tags/v1.0.0.zip
```
...
kiss uses a dual-catalog system:
...
```json
{
  ...
  "catalog_url": "https://raw.githubusercontent.com/DauQuangThanh/kiss-u/main/presets/catalog.community.json",
  "presets": {
    "your-preset": {
      ...
      "author": "Your Name",
      "version": "1.0.0",
      "download_url": "https://github.com/your-org/kiss-preset-your-preset/archive/refs/tags/v1.0.0.zip",
      "repository": "https://github.com/your-org/kiss-preset-your-preset",
      "license": "MIT",
      "requires": {
        "kiss_version": ">=0.1.0"
...
- [ ] Preset tested with `kiss preset add --dev`
- [ ] Templates resolve correctly (`kiss preset resolve`)
...
Once verified, `verified: true` is set and the preset appears in `kiss preset search`.
