...
This guide explains how to publish your workflow to the kiss workflow catalog, making it discoverable by `kiss workflow search`.
...
1. **Valid Workflow**: A working `workflow.yml` that passes `kiss workflow run` validation
...
# Check validation
kiss workflow info ./workflow.yml
...
```text
https://raw.githubusercontent.com/your-org/kiss-workflow-your-workflow/v1.0.0/workflow.yml
```

### 5. Test Installation from URL

```bash
kiss workflow add your-workflow
...
```json
{
  ...
  "workflows": {
    "your-workflow": {
      ...
      "author": "Your Name",
      "version": "1.0.0",
      "url": "https://raw.githubusercontent.com/your-org/kiss-workflow-your-workflow/v1.0.0/workflow.yml",
      "repository": "https://github.com/your-org/kiss-workflow-your-workflow",
      "license": "MIT",
      "requires": {
        "kiss_version": ">=0.15.0"
      },
...
### Checklist
- [ ] Valid workflow.yml (passes `kiss workflow info`)
- [ ] README.md with description, inputs, and step graph
- [ ] LICENSE file included
- [ ] GitHub release created with raw YAML URL
- [ ] Workflow tested end-to-end with `kiss workflow run`
...
Once verified, the workflow appears in `kiss workflow search`.
