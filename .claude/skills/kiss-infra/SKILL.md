---
name: "kiss-infra"
description: "Draft infrastructure-as-code plan — cloud accounts, networks, compute/storage/database resources, IAM boundaries. Produces a tool-neutral design + a starter module for the chosen IaC tool. Does not provision anything."
compatibility: "Requires kiss project structure with .kiss/ directory"
metadata:
  author: "github-kiss"
  source: "agent-skills/kiss-infra/kiss-infra.md"
user-invocable: true
...
```bash
INFRA_TOOL=terraform INFRA_CLOUD=aws bash <SKILL_DIR>/kiss-infra/scripts/bash/draft-infra.sh --auto
```
