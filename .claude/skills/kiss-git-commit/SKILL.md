...
metadata:
  author: github-kiss
  source: git:commands/kiss.git.commit.md
---
...
2. Checks `.kiss/extensions/git/git-config.yml` for the `auto_commit` section
...
- **Bash**: `.kiss/extensions/git/scripts/bash/auto-commit.sh <event_name>`
- **PowerShell**: `.kiss/extensions/git/scripts/powershell/auto-commit.ps1 <event_name>`
