...
name: kiss-standup
description: >-
  Logs daily standup notes from content the user pastes in. Extracts
  blockers into a tracked impediments list. Does NOT facilitate the
  standup — the team runs the meeting and tells the AI what happened.
  Use when recording daily standup notes, tracking impediments, or
  logging what each team member did yesterday / today / blocked on.
license: MIT
