# Bootstrap a project-local virtualenv for kiss-docx-markdown (Windows / PowerShell).
#
...
if (-not $pandocCheck) {
    Write-Host ""
    Write-Host "[$SkillName] warning: 'pandoc' is not on PATH."
