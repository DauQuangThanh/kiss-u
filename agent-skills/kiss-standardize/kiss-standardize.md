...
description: >-
  Creates or updates the project standards from interactive or provided
  principle inputs, ensuring all dependent templates stay in sync.
  Use when defining coding standards, setting project conventions,
  or establishing style guidelines for a new or existing project.
license: MIT
