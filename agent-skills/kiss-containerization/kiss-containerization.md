...
description: >-
  Drafts Dockerfile / compose / image-build strategy for the project.
  Produces a multi-stage Dockerfile starter, a compose file for
  local dev, and the design doc. Does not build or push images. Use
  when dockerising an application, planning a container strategy, or
  when the project needs Docker or Docker Compose configuration.
license: MIT
