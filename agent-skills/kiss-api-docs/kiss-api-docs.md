...
name: kiss-api-docs
description: >-
  Generates API documentation from source code: lists endpoints /
  RPC methods / queue topics with their schemas and auth. Works
  backward from routes + OpenAPI / proto / gql definitions. Use when
  documenting an API, generating endpoint reference docs, or when
  the project needs OpenAPI, gRPC, or GraphQL schemas documented.
license: MIT
