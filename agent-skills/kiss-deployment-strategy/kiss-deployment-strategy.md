---
name: kiss-deployment-strategy
description: >-
  Drafts the deployment strategy + release runbook — canary /
  blue-green / rolling, promotion flow, rollback, feature flags,
  release-notes seed. Produces a runbook the on-call team uses.
  Does not deploy. Use when planning a deployment strategy, defining
  a release process, or choosing between canary, blue-green, or
