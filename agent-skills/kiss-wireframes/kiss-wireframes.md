...
description: >-
  Drafts text-based wireframes + Mermaid user-flow diagrams for the
  active feature, from user stories and a named persona. Produces
  two artefacts: screen sketches + flow diagrams. Does not conduct
  user research. Use when designing UI screens, mapping user journeys,
  or creating wireframes and flow diagrams for a feature.
license: MIT
