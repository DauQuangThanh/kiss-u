...
description: >-
  Authors Given/When/Then acceptance criteria for user stories.
  Drafts criteria from the spec and lets the user refine them; does
  not approve or sign off. Produces the single file that testers and
  product-owner both reference. Use when writing acceptance criteria,
  defining what "done" means for a story, or when user stories need
