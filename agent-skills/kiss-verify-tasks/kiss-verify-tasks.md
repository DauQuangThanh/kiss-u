...
description: >-
  Performs a non-destructive cross-artefact consistency and quality
  analysis across spec.md, plan.md, and tasks.md after task
  generation. Use when validating tasks.md after running kiss-taskify,
  checking that tasks align with the spec and plan, or before
...
- Load `{context.paths.docs}/standards.md` for principle validation
...
- If CRITICAL issues exist: Recommend resolving before `/kiss.implement`
