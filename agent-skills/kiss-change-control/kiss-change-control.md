...
description: >-
  Maintains a project change-request ledger. Captures incoming change
  requests, drafts impact assessments (scope / schedule / budget /
  quality), records CCB decisions the user reports, and tracks
  implementation. Authors and maintains the ledger; never approves,
  rejects, or decides a change itself. Use when managing change
  requests, tracking scope changes, or recording CCB decisions.
license: MIT
