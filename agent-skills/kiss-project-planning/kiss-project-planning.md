...
description: >-
  Drafts and maintains a project plan: scope statement, work breakdown
  structure (WBS), milestones, dependencies, critical path, resource
  allocation, and Definition of Done. Supports Agile/Scrum, Kanban,
  Waterfall, and Hybrid methodologies. Also drafts the companion
  communication plan. Does not schedule meetings or commit a team.
  Use when starting a project, creating a project plan, defining
  milestones, or managing WBS and delivery schedule.
license: MIT
