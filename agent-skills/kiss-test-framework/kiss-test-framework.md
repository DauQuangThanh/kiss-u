...
description: >-
  Recommends unit + integration + e2e frameworks that fit the project's
  language + architecture, drafts the folder layout, and lists the
  tooling versions. Use when choosing a test framework, setting up
  testing infrastructure, or defining the test toolchain for a
  new project or language stack.
license: MIT
