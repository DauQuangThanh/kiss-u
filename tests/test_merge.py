...
from kiss_cli.installer import merge_json_files, handle_vscode_settings
...
def test_merge_vscode_realistic_scenario(tmp_path):
    ...
    # Check additions
    assert merged["chat.promptFilesRecommendations"]["kiss.specify"] is True
    assert merged["chat.tools.terminal.autoApprove"][".kiss/scripts/bash/"] is True
