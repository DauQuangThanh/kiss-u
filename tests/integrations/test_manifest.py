...
from kiss_cli.integrations.manifest import IntegrationManifest, _sha256
...
class TestManifestPersistence:
    ...
    def test_manifest_path(self, tmp_path):
        ...
        assert m.manifest_path == tmp_path / ".kiss" / "integrations" / "copilot.manifest.json"
...
class TestManifestLoadValidation:
    def test_load_non_dict_raises(self, tmp_path):
        path = tmp_path / ".kiss" / "integrations" / "bad.manifest.json"
