...
class RunState:
    ...
    def runs_dir(self) -> Path:
        return self.project_root / ".kiss" / "workflows" / "runs" / self.run_id
    ...
    def load(cls, run_id: str, project_root: Path) -> RunState:
        ...
        runs_dir = project_root / ".kiss" / "workflows" / "runs" / run_id
...
class WorkflowEngine:
    ...
    def execute(
        ...
        run_dir = self.project_root / ".kiss" / "workflows" / "runs" / state.run_id
    ...
    def resume(self, run_id: str) -> RunState:
        ...
        run_dir = self.project_root / ".kiss" / "workflows" / "runs" / run_id
    ...
    def list_runs(self) -> list[dict[str, Any]]:
        ...
        runs_dir = self.project_root / ".kiss" / "workflows" / "runs"
