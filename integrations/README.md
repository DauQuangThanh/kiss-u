# kiss Integration Catalog

The integration catalog enables discovery, versioning, and distribution of AI agent integrations for kiss.

## Catalog Files

### Built-In Catalog (`catalog.json`)

Contains integrations that ship with kiss. These are maintained by the core team and always installable.
...
1. **Environment variable** — `KISS_INTEGRATION_CATALOG_URL` overrides all catalogs with a single URL
2. **Project config** — `.kiss/integration-catalogs.yml` in the project root
3. **User config** — `~/.kiss/integration-catalogs.yml` in the user home directory
...
kiss integration install copilot
...
integration:
  ...
  author: "my-org"
  repository: "https://github.com/my-org/kiss-my-agent"
  license: "MIT"
requires:
  kiss_version: ">=0.6.0"
  tools:
